    ...
    return (
        ...
        >
            <div className="flex flex-col gap-[16px] max-[768px]:gap-[10px]">
                <img src="/burgerMeatBomb.png" className="w-full h-[220px] rounded-[12px] max-[768px]:h-[120px]" />
                <div className="flex flex-col gap-[8px] max-[768px]:gap-[4px]">
                    ...
                    <p className="font-nunito max-[768px]:text-[12px]">Мясная бомба</p>
                </div>
            </div>
            <div className="flex flex-col gap-[8px] max-[768px]:gap-[7px]">
                ...
                <button className="w-full py-[12px] font-nunito bg-[#F2F2F3] rounded-[12px] max-[768px]:py-[9px] max-[768px]:rounded-[9px] max-[768px]:text-[12px]">Добавить</button>
            </div>
        </div>
    );
}
