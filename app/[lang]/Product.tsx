    ...
    return (
        ...
        >
            <div className="flex flex-col gap-[16px] max-[768px]:gap-[10px]">
                <img src={arr.imageUrl} className="w-full h-[220px] object-cover rounded-[12px] max-[768px]:h-[120px]" />
                <div className="flex flex-col gap-[8px] max-[768px]:gap-[4px]">
                    <p className="text-[24px] font-semibold font-nunito max-[768px]:text-[16px]">{arr.price}</p>
                    <p className="font-nunito max-[768px]:text-[12px]">{arr.title}</p>
                </div>
            </div>
            <div className="flex flex-col gap-[8px] max-[768px]:gap-[7px]">
                <p className="font-semibold font-nunito text-[#B1B1B1] max-[768px]:text-[12px]">{arr.weight}</p>
